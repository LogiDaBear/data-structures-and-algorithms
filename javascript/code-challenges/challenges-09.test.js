...
const updateNumbers = (obj) => {
  function convertPhoneNumbers(obj) {
...
const getHouses = (arr) => {
  ...
  function getHouses(data) {
    return data.map(item => item.house);
  }
...
const hasChildrenValues = (arr, character) => {
  function hasChildrenValues(data, character) {
    const values = Object.values(data);
    const target = values.find(obj => obj.name === character);
